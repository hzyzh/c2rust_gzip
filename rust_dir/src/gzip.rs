...
extern "C" {
    ...
    fn updcrc(s: *mut uch, n: libc::c_uint) -> ulg;
    fn clear_bufs();
    ...
    fn lzw(in_0: libc::c_int, out: libc::c_int) -> libc::c_int;
...
unsafe fn main_0(
    ...
    loop {
        ...
        if !env_argv.is_null() {
                ...
                ) == 0 as libc::c_int
            {
                ...
                if 0 as libc::c_int <= optc {
                    ...
                    free(env_argv as *mut libc::c_void);
        ...
        match optc {
            ...
            180 | 181 | 182 | 183 | 184 | 185 | 186 | 187 | 188 => {
                optc -= ENV_OPTION as libc::c_int;
                current_block_76 = 13504833460577680657;
            }
    ...
    if do_lzw != 0 && decompress == 0 {
        work = Some(
            lzw as unsafe extern "C" fn(libc::c_int, libc::c_int) -> libc::c_int,
        );
    }
    ...
    if file_count != 0 as libc::c_int {
        to_stdout != 0 && test == 0 && list == 0 && (decompress == 0 || ascii == 0);
        while optind < argc {
            let fresh2 = optind;
            optind = optind + 1;
    ...
    if list != 0 {
        if quiet == 0 && (1 as libc::c_int) < file_count {
            do_list(-(1 as libc::c_int), -(1 as libc::c_int));
        }
...
unsafe extern "C" fn input_eof() -> libc::c_int {
    ...
    if inptr == insize {
        if insize != 0x8000 as libc::c_int as libc::c_uint
...
unsafe extern "C" fn treat_stdin() {
    ...
    test == 0 && list == 0 && (decompress == 0 || ascii == 0);
    strcpy(ifname.as_mut_ptr(), b"stdin\0" as *const u8 as *const libc::c_char);
        ...
        if force == 0 {
            ...
            if 2 as libc::c_int as libc::c_ulong <= istat.st_nlink {
                if quiet == 0 {
                    rpl_fprintf(
                        stderr,
                        b"%s: %s has %lu other link%c -- unchanged\n\0" as *const u8
                            as *const libc::c_char,
                        program_name,
                        ifname.as_mut_ptr(),
...
unsafe extern "C" fn get_suffix(mut name: *mut libc::c_char) -> *mut libc::c_char {
    ...
    free(z_lower as *mut libc::c_void);
    return match_0;
}
    ...
    *suf = z_suffix;
        ...
        .wrapping_sub(1 as libc::c_int as libc::c_ulong) <= strlen(iname))
    {
        ...
        loop {
            ...
            {
                current_block = 9126047426189137434;
                break;
            }
...
unsafe extern "C" fn get_method(mut in_0: libc::c_int) -> libc::c_int {
        ...
        ) == 0 as libc::c_int
    {
        ...
        if flags as libc::c_int & 0x2 as libc::c_int != 0 {
            ...
            updcrc(0 as *mut uch, 0 as libc::c_int as libc::c_uint);
...
unsafe extern "C" fn do_list(mut ifd_0: libc::c_int, mut method_0: libc::c_int) {
    ...
    bytes_out = -(1 as libc::c_long);
    bytes_in = ifile_size;
    if method_0 == 8 as libc::c_int && last_member == 0 {
        bytes_in = lseek(ifd_0, -(8 as libc::c_int) as off_t, 2 as libc::c_int);
        if bytes_in != -(1 as libc::c_long) {
            let mut buf: [uch; 8] = [0; 8];
            bytes_in += 8 as libc::c_long;
            if read(
                ifd_0,
                buf.as_mut_ptr() as *mut libc::c_char as *mut libc::c_void,
                ::core::mem::size_of::<[uch; 8]>() as libc::c_ulong,
            ) as libc::c_ulong != ::core::mem::size_of::<[uch; 8]>() as libc::c_ulong
            {
                read_error();
            }
            crc = (buf[0 as libc::c_int as usize] as ush as libc::c_int
                | (buf[1 as libc::c_int as usize] as ush as libc::c_int)
            ...
            bytes_out = ((*buf
                ...
                | ((*buf
                    ...
                    | (*buf
                        ...
                        .offset(2 as libc::c_int as isize)
                        .offset(1 as libc::c_int as isize) as ush as libc::c_int)
                        << 8 as libc::c_int) as ulg) << 16 as libc::c_int) as off_t;
        }
    }
    if verbose != 0 {
