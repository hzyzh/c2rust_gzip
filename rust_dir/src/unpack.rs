...
static orig_len: ulg = 0;
static max_len: libc::c_int = 0;
static literal: [uch; 256] = [0; 256];
static lit_base: [libc::c_int; 26] = [0; 26];
static leaves: [libc::c_int; 26] = [0; 26];
static parents: [libc::c_int; 26] = [0; 26];
static peek_bits: libc::c_int = 0;
static bitbuf: ulg = 0;
static valid: libc::c_int = 0;
