...
#[no_mangle]
pub unsafe extern "C" fn lm_init(mut pack_level: libc::c_int, mut flags: *mut ush) {
    ...
    max_chain_length = configuration_table[pack_level as usize].max_chain
        as libc::c_uint;
    if pack_level == 1 as libc::c_int {
        *flags = (*flags as libc::c_int | 4 as libc::c_int) as ush;
    } else if pack_level == 9 as libc::c_int {
        *flags = (*flags as libc::c_int | 2 as libc::c_int) as ush;
    }
...
#[no_mangle]
pub unsafe extern "C" fn deflate() -> off_t {
    let mut hash_head: IPos = 0;
    ...
    let mut match_length: libc::c_uint = (3 as libc::c_int - 1 as libc::c_int)
        as libc::c_uint;
    if compr_level <= 3 as libc::c_int {
        return deflate_fast();
    }
    while lookahead != 0 as libc::c_int as libc::c_uint {
        ins_h = (ins_h
