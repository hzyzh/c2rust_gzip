...
pub unsafe extern "C" fn copy(
    ...
    *__errno_location() = 0 as libc::c_int;
    while insize > inptr {
        ...
        bytes_out += insize.wrapping_sub(inptr) as libc::c_long;
        got = read_buffer(
            in_0,
...
#[no_mangle]
pub unsafe extern "C" fn updcrc(mut s: *mut uch, mut n: libc::c_uint) -> ulg {
    let mut c: ulg = 0;
...
pub unsafe extern "C" fn fill_inbuf(mut eof_ok: libc::c_int) -> libc::c_int {
    ...
    loop {
        len = read_buffer(
            ...
            (0x8000 as libc::c_int as libc::c_uint).wrapping_sub(insize),
        );
...
pub unsafe extern "C" fn flush_outbuf() {
    ...
    write_buf(ofd, outbuf.as_mut_ptr() as *mut libc::c_char as voidp, outcnt);
    bytes_out += outcnt as off_t;
    outcnt = 0 as libc::c_int as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn flush_window() {
    ...
    if test == 0 {
        write_buf(ofd, window.as_mut_ptr() as *mut libc::c_char as voidp, outcnt);
    }
    bytes_out += outcnt as off_t;
    outcnt = 0 as libc::c_int as libc::c_uint;
}
...
pub unsafe extern "C" fn strlwr(mut s: *mut libc::c_char) -> *mut libc::c_char {
    ...
    while *t != 0 {
        *t = (if *(*__ctype_b_loc()).offset(*t as libc::c_uchar as libc::c_int as isize)
            ...
            != 0
        {
            tolower(*t as libc::c_uchar as libc::c_int)
        } else {
...
pub unsafe extern "C" fn add_envopt(
    ...
    if nargc == 0 as libc::c_int {
        free(env_val as *mut libc::c_void);
        return 0 as *mut libc::c_char;
    }
